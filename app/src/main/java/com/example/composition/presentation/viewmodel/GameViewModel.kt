...
class GameViewModel(
    ...
    private fun updateProgress() {
        ...
        _enoughCount.value = countOfAnswer >= gameSettings.minCountOfRightAnswers
    ...
    private fun calculatePercentOfRightAnswer(): Int {
        ...
        return ((countOfAnswer / countOfQuestion.toDouble()) * 100).toInt()
    }
    ...
    private fun finishGame() {
        _gameResult.value = GameResult(
            ...
            countOfRightAnswers = countOfAnswer,
